[README.md](https://github.com/user-attachments/files/25563405/README.md)
# PSUSphere
...
1.  *Clone the repository:*
    ...
    git clone [https://github.com/NexieMadia23/PSUSphere](https://github.com/NexieMadia23/PSUSphere)
    cd PSUSphere
...
* *[Norelyn Madia]* - Repository Owner
* *[Princess Heaven Rica]* - Collaborator
